...
from authors.serializers import BookSerializer
...
#    def book_name_only(self, request, pk=None):
#        book = get_object_or_404(Book, pk=pk)
...
#
# class BookCustomViewSet(ListModelMixin, DestroyModelMixin,GenericViewSet):
#     queryset =  Book.objects.all()
#     serializer_class =  BookSerializer
#     renderer_classes = [JSONRenderer, BrowsableAPIRenderer]
...
#        return Book.objects.filter(name__contains='Кни')
#
#
# class BookListAPIView(ListAPIView):
#    serializer_class = BookSerializer
